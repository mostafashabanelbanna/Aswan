...
import { newsList, clearNewsList, getNewsCatrgory, getNewsSectors } from "../../store/actions/News_Action";
...
const mapDispatchToProps = (dispatch) => {
  return bindActionCreators({ newsList, clearNewsList, getNewsCatrgory, getNewsSectors }, dispatch);
};
