            ...
            <div>
                <div className=" container my-4 d-flex flex-column flex-md-row justify-content-end align-items-center">
                    <div class="form-group col-lg-2 col-md-4 col-6">
                        <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="كلمات البحث مثل مدارس" />
                    </div>
                    ...
                    <div className='d-flex justify-content-center col-lg-1'> <button type="submit" class="btn btn-secondary">بحث</button></div>
                </div>
                <div className="d-flex flex-wrap justify-content-around flex-column flex-sm-row">
                    {props.services.result.map((item, index) => {
                        return (
                            <div className="text-center my-4 col-lg-3 mx-md-4 col-md-5 mx-0 col-11 p-4  bg-light" key={item.id}>
                                <div className='justify-content-end d-flex my-2 text-muted'>{item.name}</div>

                                <div className=' justify-content-start d-flex my-2'>{item.serviceCategoryName}</div>
                                <div className='d-flex'>
                                    <div className='mx-2'>  <FontAwesomeIcon icon={faLink} size={'x2'} ></FontAwesomeIcon></div>
                                    <div className='mx-2'> <a style={{ textDecoration: 'none', cursor: 'pointer' }} >الرابط</a></div>
                                </div>
