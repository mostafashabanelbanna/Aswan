      ...
      <div className="d-flex justify-content-lg-around flex-column flex-md-row">
        <div className="col-lg-4 mb-4 mb-lg-0">
          <img
            ...
            alt=""
          />
          <p className="text-center content mb-5">نهر النيل في اسوان</p>
          ...
          <p className="text-center content">مقابر النبلاء</p>
        </div>
        ...
        <div className="col-lg-4 mb-4 mb-lg-0 me-md-4">
          ...
          <p className="text-center content mb-5">الحديقة النباتية بأسوان</p>
          ...
          <p className="text-center content">كلابشة</p>
        </div>
        ...
        <div className="col-lg-4 mb-4 mb-lg-0 me-md-4">
          ...
          <p className="text-center content mb-5">متحف النوبة</p>
          ...
          <p className="text-center content">المسلة الغير مكتملة</p>
        </div>
      </div>
