...
export const paths = {
  ...
  youthAttachment: `${MainPath}YouthEmployent/Attachment/`,
  careerPhoto: `${MainPath}Career/Photo/`,
  careerAttachment: `${MainPath}Career/Attachment/`,
  TouristAttractionSlider: `${MainPath}PhotoLibraryPhoto/Photo/`,
  EventsPhotos: `${MainPath}Event/Photo/`,
  EventAttachment: `${MainPath}Event/Agenda/`,
